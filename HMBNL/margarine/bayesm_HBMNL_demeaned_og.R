...
# Matches Python Implementation (Liesel) and Paper Specifications
# ==============================================================================
...
export_dir <- file.path(dirname(script_dir), "margarine", "Data")
...
save(mu_draws_df, delta_draws_df, beta_reordered, n_samples, file = save_path)
