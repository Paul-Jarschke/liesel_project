...
DATA_FILENAME <- "sim_data_U300_O30_A4_K3_D2_pvec602020_seed101.json"

# Define parametes to match the liesel implementation

N_COMP <- 3 # Number of mixture components
R_TOTAL <- 41000 # Total MCMC draws
BURN_IN <- 2000 # Burn-in draws to discard (this is increased to 200 here since, we need to increase the burnin for the liesel model)
