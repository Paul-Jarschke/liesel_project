...
# MODEL: 10 Normal Components (K=10) | Raw X Variables | NO Demographics (Z)
...
Prior <- list(
    ncomp = K, # K = 10 Normal components
...
save_path <- file.path(export_dir, "bayesm_output_margarine_10comp_rawX_noZ.RData")
